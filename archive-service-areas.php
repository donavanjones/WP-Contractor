...
<?php include("inc/banners/service-area-archive-banner.php"); ?>
...
<?php
      ...
      <div id="content">
        <?php
          ...
          echo "<h1>".$dj_web_media['archive-title']."</h1>";
          echo "<p class='lead h3'>".$dj_web_media['archive-subtitle-section']."</p>";
          echo "<p>".$dj_web_media['archive-body']."</p>";
        ...
        <?php
            if ( have_posts() ) {
              ...
              echo "<div class='row'>";
                ...
                echo "<h2 class='card-title text-center card-title-bg p-2 d-flex justify-content-center align-items-center align-self-center' style='min-height: 80px;'>" . $title ."</h2>";
...
<div class="row">
<div class="highlight-box-no-radius mt-0 pb-5">
<div class="container text-center">
<p class="h1 count-down-timer-title">Get Your Free In-Home Water Test Today!</p>
<div class='col-md-12 col-12'>
        <div class='btn-group w-100'>
          <a class='btn btn-cta w-100' href='tel:863-225-2918'>Call</a>
          <a class='btn btn-primary w-100' href='http://localhost/fwapinellas/request-free-water-test/'>FREE Water Test</a>
          <a class='btn btn-danger w-100' href='http://localhost/fwapinellas/request-free-water-test/'>My Water Is Fine</a>
          </div>
          </div>
</div>
</div>
