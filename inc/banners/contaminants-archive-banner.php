<?php  
  ...
  echo '<div class="container-fluid jumbotron  jumbotron-service-areas no-radius mb-0">';
  echo '<div class="row">';
  ...
  echo  '<h2 class="text-light">'. $dj_web_media["contaminants-archive-banner-title"] .'</h2>';
  echo  '<p class="text-light">'. $dj_web_media["contaminants-archive-banner-subtitle"] .' </p>';
  echo  '<p class="text-light">'. $dj_web_media["contaminants-archive-banner-body"] .'</p>';
