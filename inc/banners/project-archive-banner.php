<?php  
  ...
  echo  '<h2 class="text-light">'. $dj_web_media["projects-archive-banner-title"] .'</h2>';
  echo  '<p class="text-light">'. $dj_web_media["projects-archive-banner-subtitle"] .' </p>';
  echo  '<p class="text-light">'. $dj_web_media["projects-archive-banner-body"] .'</p>';
