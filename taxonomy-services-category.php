...
<?php include("inc/banner-tax-services.php"); ?>
  ...
  ?>
      ...
      <div id="content">
        ...
        <?php
            ...
            $terms = get_terms('services-category');
              ...
              if($theTerm->slug == $term->slug)
              {
                    ...
                    echo '<div class="card-deck text-center">';
                      foreach($posts as $post): // begin cycle through posts of this taxonmy
                        ...
                        echo '<div class="card mb-2 box-shadow hover">';
                        echo '<a href="'. get_the_permalink() .'">';
                          echo '<div class="card-header">';
                          echo "<h2>" . $post->post_title ."</h2>";
                          echo '</div>';
                          echo '<div class="card-body" style="padding: 0;">';
                          echo '<img src="' . $featured_img_url .  '" class="img-fluid" alt="'.$post->post_title.'" />';
                          echo $post->post_excerpt;
                          echo "<p class='btn btn-warning text-light' style='margin-top: 2%;'>View Services</p>";
                          echo "</div>";
                          echo "</a>";
                        echo "</div>";
                      endforeach;
