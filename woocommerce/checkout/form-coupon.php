...
<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
	...
	<p class="form-row form-row-last">
		<button type="submit" class="btn btn-warning text-light" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
	</p>
